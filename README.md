...
|---|------------------------------------|------------------------------|----------------|
| 1 | **Gold members spend 2.3× more than Bronze**<br>Average Gold: $1,153 vs Bronze: $498 | ![Gold Dominance](Images/total_spend_membership.png.png)| Immediate priority: Convert Silver → Gold with targeted perks |
...
- **Demo**: Try it live [here](https://customersegmentationkmeans-f9tbtxtloyjtgiefse2qzq.streamlit.app/). Input a low-spend, dissatisfied customer → see churn risk flagged.
